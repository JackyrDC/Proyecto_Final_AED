...
async function getNews() {
    const response = await fetch('http://api.mediastack.com/v1/sources? access_key = 2df46a1fd149c16f54c6d4b925ec1570 & search = abc & languages= es & categories = business & countries = us');
    const jsonResp = await response.json();
    return jsonResp;
}